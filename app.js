...
// ============================================
const products = [
    { id: 1, name: 'Футболка Oversize', price: 1900, category: 'Футболки', img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500' },
    { id: 2, name: 'Худи унисекс', price: 3500, category: 'Худи', img: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=500' },
    { id: 3, name: 'Джинсы Slim', price: 4200, category: 'Джинсы', img: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=500' },
    { id: 4, name: 'Куртка Bomber', price: 6800, category: 'Куртки', img: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=500' },
    { id: 5, name: 'Кепка', price: 1200, category: 'Аксессуары', img: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=500' },
    { id: 6, name: 'Кроссовки', price: 7500, category: 'Обувь', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500' },
];
...
function cardTemplate(p) {
    return `
        <div class="card-img-wrap">
            <img src="${p.img}" alt="${p.name}" loading="lazy" onerror="this.src='https://via.placeholder.com/400x400/f2f2f2/999?text=Фото'">
...
// ============================================
// НОВИНКИ (карусель — первые 6 товаров)
// ============================================
...
document.getElementById('checkoutBtn').addEventListener('click', () => {
    ...
    tg.showConfirm(`Ваш заказ:\n\n${orderText}\n\nИтого: ${total} ₽\n\nПодтвердить?`, (ok) => {
        if (ok) {
            tg.sendData(JSON.stringify({ action: 'new_order', items: order, total, user: tg.initDataUnsafe?.user?.first_name || 'Гость' }));
            tg.close();
        }
    });
});
